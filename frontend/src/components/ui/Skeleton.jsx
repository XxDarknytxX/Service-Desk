 ...
 *
 * Uses the `.skeleton` utility (defined in main.css) for a sweeping highlight
 * that reads well in both dark and light themes. Composable helpers cover the
 * common shapes: lines, KPI rails, tables, and cards.
 */
